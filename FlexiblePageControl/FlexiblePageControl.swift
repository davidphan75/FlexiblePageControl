...
public class FlexiblePageControl: UIView {
    ...
    public func updateInitialUI(currentPageIndex:Int){
        currentPage = currentPageIndex
        while CGFloat(currentPage) * itemSize + itemSize >= scrollView.contentOffset.x + scrollView.bounds.width - itemSize {
